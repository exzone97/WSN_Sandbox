...
public class ClusterHeadA extends Thread {
	...
	private static int ADDR_NODE3 = PropertyHelper.getInt("radio.panid", 0xDABA);
				...
				while (true) {
					try {
						...
						if (str.charAt(0) == 'Q') {
							...
							send(message, ADDR_NODE1, fio);
							hmap.put(1, message);
							System.out.println("Send Detect to NS");
							Thread.sleep(100);
							...
							if (hmapCOUNT.get(frame.getSrcAddr()) == 1) {
								...
								System.out.println(Integer.parseInt(str.substring(4)));
