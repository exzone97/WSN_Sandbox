...
public class Test_BS extends Thread {
...
//	Single hop
//	private static int ADDR_NODE2[] = { PropertyHelper.getInt("radio.panid", 0xDAAA),PropertyHelper.getInt("radio.panid", 0xDAAB)  }; // node dibwhnya
...
//								if (hmapCurr_SN.get(node) == seq) {
								send("L" + node, frame.getSrcAddr(), fio);
								Thread.sleep(100);
...
//								}
								...
								send("K" + node, frame.getSrcAddr(), fio);
							}
						}
